...
public class materiales extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        panelprincipal.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 0, 210, 300));
        ...
        panelprincipal.add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 0, 210, 300));

        jPanel6.setBackground(new java.awt.Color(46, 49, 82));
        jPanel6.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel21.setIcon(new javax.swing.ImageIcon(getClass().getResource("/mdfimg.jpeg"))); // NOI18N
        jPanel6.add(jLabel21, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, 170));

        rSButtonRiple16.setBackground(new java.awt.Color(255, 0, 51));
        rSButtonRiple16.setIcon(new javax.swing.ImageIcon(getClass().getResource("/delete (1).png"))); // NOI18N
        rSButtonRiple16.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                rSButtonRiple16ActionPerformed(evt);
            }
        });
        jPanel6.add(rSButtonRiple16, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 270, 40, 20));

        jLabel22.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        jLabel22.setForeground(new java.awt.Color(255, 255, 255));
        jLabel22.setText("Categoria: Madera");
        jPanel6.add(jLabel22, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 230, -1, -1));

        jLabel23.setFont(new java.awt.Font("Segoe UI", 1, 16)); // NOI18N
        jLabel23.setForeground(new java.awt.Color(255, 255, 255));
        jLabel23.setText("Codigo: 101");
        jPanel6.add(jLabel23, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 170, -1, -1));

        jLabel24.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        jLabel24.setForeground(new java.awt.Color(255, 255, 255));
        jLabel24.setText("Nombre: Mdf");
        jPanel6.add(jLabel24, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 200, -1, -1));

        rSButtonRiple17.setBackground(new java.awt.Color(0, 204, 102));
        rSButtonRiple17.setIcon(new javax.swing.ImageIcon(getClass().getResource("/eye (1).png"))); // NOI18N
        rSButtonRiple17.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                rSButtonRiple17ActionPerformed(evt);
            }
        });
        jPanel6.add(rSButtonRiple17, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 270, 40, 20));

        rSButtonRiple18.setBackground(new java.awt.Color(0, 153, 255));
        rSButtonRiple18.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pencil (1)_1.png"))); // NOI18N
        rSButtonRiple18.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                rSButtonRiple18ActionPerformed(evt);
            }
        });
        jPanel6.add(rSButtonRiple18, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 270, 40, 20));

        panelprincipal.add(jPanel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 0, 210, 300));
    ...
    private void rSButtonRiple16ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSButtonRiple16ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_rSButtonRiple16ActionPerformed

    private void rSButtonRiple17ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSButtonRiple17ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_rSButtonRiple17ActionPerformed

    private void rSButtonRiple18ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSButtonRiple18ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_rSButtonRiple18ActionPerformed
